...
export const supportedCountryOptions: IDropdownOption[] = [
  { text: 'United States', key: 'US' },
  { text: 'Canada', key: 'CA' }
];

export const supportedProvinceOptions: IDropdownOption[] = [
  { text: 'Alberta', key: 'AB' },
  { text: 'British Columbia', key: 'BC' },
  ...
  { text: 'Nunavut', key: 'NU' },
  { text: 'Ontario', key: 'ON' },
  { text: 'Prince Edward Island', key: 'PE' },
  { text: 'Québec', key: 'QC' },
  { text: 'Saskatchewan', key: 'SK' },
  { text: 'Yukon', key: 'YT' }
];

export const supportedStateOptions: IDropdownOption[] = [
  {
    text: 'Alabama',
    key: 'AL'
  },

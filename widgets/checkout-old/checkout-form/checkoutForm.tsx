...
import { BillingAddressChoiceGroup } from '@widgets/checkout-old/checkout-form-groups/billingAddressChoiceGroup';
import { BillingContactChoiceGroup } from '@widgets/checkout-old/checkout-form-groups/billingContactChoiceGroup';
import { OrderContactFormGroup } from '@widgets/checkout-old/checkout-form-groups/orderContactFormGroup';
import { PaymentMethodChoiceGroup } from '@widgets/checkout-old/checkout-form-groups/paymentMethodChoiceGroup';
import { ShippingAddressFormGroup } from '@widgets/checkout-old/checkout-form-groups/shippingAddressFormGroup';
import { ShippingContactFormGroup } from '@widgets/checkout-old/checkout-form-groups/shippingContactFormGroup';
import { ShippingMethodChoiceGroup } from '@widgets/checkout-old/checkout-form-groups/shippingMethodChoiceGroup';
import { TermsAndConditionsGroup } from '@widgets/checkout-old/checkout-form-groups/termsAndConditionsGroup';
import { CheckoutFormOverview } from '@widgets/checkout-old/checkout-form-overview/checkoutFormOverview';
import { CheckoutSummary } from '@widgets/checkout-old/checkout-summary/checkoutSummary';
import { mapFormFieldsToOrderPost } from '@widgets/checkout-old/checkoutHelper';

...
import { RequestForQuoteSummaryProductListStyles } from './requestForQuoteSummary.types';
import { RequestForQuoteSummaryProduct } from './requestForQuoteSummaryProduct';

export const RequestForQuoteSummaryProductsList: React.FC<{
  items: CartItem[];
}> = ({ items }) => {
  ...
  const styles: RequestForQuoteSummaryProductListStyles = {
    listItem: {
      root: {
        selectors: {
      ...
      <Stack.Item styles={styles.listItem}>
        <Stack>
          ...
          <List
            ...
            onRenderCell={item => {
              return item ? (
                <RequestForQuoteSummaryProduct item={item} />
              ) : null;
            }}
          />
        </Stack>
